<a href="index.php?page=siswa" class="tambah">Kembali ke Data siswa</a>
<br /><br />
<?php
    include "../koneksi.php";
...
?>
    ...
    <form action="halaman/siswa/siswaubah_aksi.php" method="post" name="formubah">
        <table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="tombolubah" value="Ubah" class="button-ubah" onclick="return confirm('Apa Anda yakin akan mengubah data siswa?')">
            </tr>
        </table>
    </form>
