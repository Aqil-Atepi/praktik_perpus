<a href="index.php?page=buku" class="tambah">Kembali ke Data Buku</a>
<br /><br />
<?php
    include "../koneksi.php";
    $idbuku = $_GET['idbuku'];
...
?>
    ...
    <form action="halaman/buku/bukuubah_aksi.php" method="post" name="formubah">
        <table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="tombolubah" value="Ubah" class="button-ubah"  onclick="return confirm('Apa Anda yakin akan mengubah data buku?')">
            </tr>
        </table>
    </form>
