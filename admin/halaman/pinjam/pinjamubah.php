<a href="index.php?page=pinjam" class="tambah">Kembali ke Data Peminjaman</a>
<br /><br />
<?php
    include "../koneksi.php";
    $idpinjam = $_GET['idpinjam'];
    $ambildata = mysqli_query($sambung, "SELECT * FROM tbl_peminjaman INNER JOIN tbl_petugas ON tbl_petugas.idpetugas=tbl_peminjaman.idpetugas INNER JOIN tbl_siswa ON tbl_siswa.idsiswa=tbl_peminjaman.idsiswa INNER JOIN tbl_buku ON tbl_buku.idbuku=tbl_peminjaman.idbuku WHERE idpinjam='$idpinjam'");
...
?>
    ...
    <form action="halaman/pinjam/pinjamubah_aksi.php" method="post" name="formubah">
        <table>
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="tombolubah" value="Ubah" class="button-ubah" ></td>
            </tr>
        </table>
    </form>
